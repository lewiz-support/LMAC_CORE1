...
LMAC Core1 and LMAC Core2 have the same architecture. The software device driver is similar for both cores.
...
A video of the co-simulation demo is available at:
	https://youtu.be/PMsvJDp8lCQ
