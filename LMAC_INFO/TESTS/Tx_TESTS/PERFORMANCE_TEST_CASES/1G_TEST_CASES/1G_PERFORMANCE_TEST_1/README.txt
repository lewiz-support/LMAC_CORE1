...
For the maximum performance, the minimum activated time of wrempty  singal should be push to 12ns (not including the first pkt)

To run this test:

1.Run the following script
source C:/LMAC_INFO/TESTS/Tx_TESTS/PERFORMANCE_TEST_CASES/1G_TEST_CASES/1G_PERFORMANCE_TEST_1/script_1G.txt
