...
10M
 ...
 1)  MAC address: Broadcast, Packet Type: Normal IP.
     Packet length = 257Bytes
     No. of valid Bytes in last Quadword = 1
     
 2)  MAC address: Unicast, Packet Type: Normal IP.
     Packet Length = 896 Bytes.
     No. of valid Bytes in last Quadword = 8

 3)  MAC address: Multicast, Type: Normal IP.
     Packet Length = 888 Bytes
     No. of valid Bytes in last quadword = 8.
 ...
 Number of bytes between packet 1 and 2 = 18B


 Number of Bytes between packet 2 and 3  = 11B 