...
HD_PWD='/home/lewiz/sambashare/KIRATEY/LMAC_DFIFO_BRIDGE_IP/LMAC_DFIFO_BRIDGE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LMAC_DFIFO_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LMAC_DFIFO_TOP.tcl
