...
HD_PWD='/home/lewiz/sambashare/KIRATEY/LMAC_DFIFO_BRIDGE_IP/LMAC_DFIFO_BRIDGE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LMAC_DFIFO_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LMAC_DFIFO_TOP.tcl -notrace
