...
HD_PWD='/home/lewiz/sambashare/KIRATEY/LMAC_DFIFO_BRIDGE/LMAC_DFIFO_BRIDGE.runs/RX_DFIFO_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RX_DFIFO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RX_DFIFO.tcl
