...
-- Date        : Sun Apr  7 11:18:25 2019
-- Host        : ubeluga running 64-bit Ubuntu 18.04.4 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top ps_emio_eth_1g_util_ds_buf_0_0 -prefix
--               ps_emio_eth_1g_util_ds_buf_0_0_ ps_emio_eth_1g_util_ds_buf_0_0_sim_netlist.vhdl
-- Design      : ps_emio_eth_1g_util_ds_buf_0_0
...
entity ps_emio_eth_1g_util_ds_buf_0_0_util_ds_buf is
  port (
  ...
  attribute C_BUF_TYPE of ps_emio_eth_1g_util_ds_buf_0_0_util_ds_buf : entity is "IBUFDS";
  attribute C_SIZE : integer;
  attribute C_SIZE of ps_emio_eth_1g_util_ds_buf_0_0_util_ds_buf : entity is 1;
end ps_emio_eth_1g_util_ds_buf_0_0_util_ds_buf;

architecture STRUCTURE of ps_emio_eth_1g_util_ds_buf_0_0_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ps_emio_eth_1g_util_ds_buf_0_0 is
  port (
    IBUF_DS_P : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_DS_N : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_OUT : out STD_LOGIC_VECTOR ( 0 to 0 )
  ...
  attribute NotValidForBitStream of ps_emio_eth_1g_util_ds_buf_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of ps_emio_eth_1g_util_ds_buf_0_0 : entity is "ps_emio_eth_1g_util_ds_buf_0_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of ps_emio_eth_1g_util_ds_buf_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of ps_emio_eth_1g_util_ds_buf_0_0 : entity is "util_ds_buf,Vivado 2018.2";
end ps_emio_eth_1g_util_ds_buf_0_0;

architecture STRUCTURE of ps_emio_eth_1g_util_ds_buf_0_0 is
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 100000000, CLK_DOMAIN ps_emio_eth_1g_util_ds_buf_0_0_IBUF_OUT";
begin
U0: entity work.ps_emio_eth_1g_util_ds_buf_0_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_I(0) => '0',
