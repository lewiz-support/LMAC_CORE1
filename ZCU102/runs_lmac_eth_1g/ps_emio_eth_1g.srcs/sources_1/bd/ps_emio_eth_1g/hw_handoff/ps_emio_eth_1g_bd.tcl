...
proc create_root_design { parentCell } {
  ...
  set s_axis_tready_led [ create_bd_port -dir O s_axis_tready_led ]
  ...
  # Create instance: AXIS_LMAC_0, and set properties
  set AXIS_LMAC_0 [ create_bd_cell -type ip -vlnv lewiz:lewiz:AXIS_LMAC:1.0 AXIS_LMAC_0 ]
  ...
  connect_bd_intf_net -intf_net AXIS_LMAC_0_gmii_rtl [get_bd_intf_pins AXIS_LMAC_0/gmii_rtl] [get_bd_intf_pins gig_ethernet_pcs_pma_0/gmii_pcs_pma]
  connect_bd_intf_net -intf_net AXIS_LMAC_0_m_axis [get_bd_intf_pins AXIS_LMAC_0/m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins AXIS_LMAC_0/s_axis] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  # Create port connections
  connect_bd_net -net AXIS_LMAC_0_gmii_tx_en [get_bd_pins AXIS_LMAC_0/gmii_tx_en] [get_bd_pins gig_ethernet_pcs_pma_0/gmii_tx_en] [get_bd_pins ila_0/probe1]
  connect_bd_net -net AXIS_LMAC_0_gmii_tx_er [get_bd_pins AXIS_LMAC_0/gmii_tx_er] [get_bd_pins gig_ethernet_pcs_pma_0/gmii_tx_er]
  connect_bd_net -net AXIS_LMAC_0_gmii_txd [get_bd_pins AXIS_LMAC_0/gmii_txd] [get_bd_pins gig_ethernet_pcs_pma_0/gmii_txd] [get_bd_pins ila_0/probe0]
  connect_bd_net -net AXIS_LMAC_0_m_axis_tdata [get_bd_pins AXIS_LMAC_0/m_axis_tdata] [get_bd_pins axi_dma_0/s_axis_s2mm_tdata] [get_bd_pins ila_0/probe5]
  connect_bd_net -net AXIS_LMAC_0_m_axis_tkeep [get_bd_pins AXIS_LMAC_0/m_axis_tkeep] [get_bd_pins axi_dma_0/s_axis_s2mm_tkeep] [get_bd_pins ila_0/probe6]
  connect_bd_net -net AXIS_LMAC_0_m_axis_tlast [get_bd_pins AXIS_LMAC_0/m_axis_tlast] [get_bd_pins axi_dma_0/s_axis_s2mm_tlast] [get_bd_pins ila_0/probe7]
  connect_bd_net -net AXIS_LMAC_0_m_axis_tvalid [get_bd_pins AXIS_LMAC_0/m_axis_tvalid] [get_bd_pins axi_dma_0/s_axis_s2mm_tvalid] [get_bd_pins ila_0/probe8]
  connect_bd_net -net AXIS_LMAC_0_s_axis_tready [get_bd_ports s_axis_tready_led] [get_bd_pins AXIS_LMAC_0/s_axis_tready]
  connect_bd_net -net Net [get_bd_pins constants/config_valid] [get_bd_pins gig_ethernet_pcs_pma_0/an_restart_config]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_dma_0_s_axis_s2mm_tready [get_bd_pins AXIS_LMAC_0/m_axis_tready] [get_bd_pins axi_dma_0/s_axis_s2mm_tready] [get_bd_pins ila_0/probe9]
  ...
  connect_bd_net -net gig_ethernet_pcs_pma_0_gmii_rx_dv [get_bd_pins AXIS_LMAC_0/gmii_rx_dv] [get_bd_pins gig_ethernet_pcs_pma_0/gmii_rx_dv] [get_bd_pins ila_0/probe3]
  connect_bd_net -net gig_ethernet_pcs_pma_0_gmii_rx_er [get_bd_pins AXIS_LMAC_0/gmii_rx_er] [get_bd_pins gig_ethernet_pcs_pma_0/gmii_rx_er] [get_bd_pins ila_0/probe4]
  connect_bd_net -net gig_ethernet_pcs_pma_0_gmii_rxd [get_bd_pins AXIS_LMAC_0/gmii_rxd] [get_bd_pins gig_ethernet_pcs_pma_0/gmii_rxd] [get_bd_pins ila_0/probe2]
  connect_bd_net -net gig_ethernet_pcs_pma_0_resetdone [get_bd_ports xcvr_rst_done_led] [get_bd_pins AXIS_LMAC_0/rst_] [get_bd_pins gig_ethernet_pcs_pma_0/resetdone]
  ...
  connect_bd_net -net gig_ethernet_pcs_pma_0_userclk2_out [get_bd_pins AXIS_LMAC_0/lclk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins gig_ethernet_pcs_pma_0/userclk2_out]
  ...
  connect_bd_net -net util_ds_buf_1_BUFG_O [get_bd_pins c_counter_binary_1/CLK] [get_bd_pins ila_0/clk] [get_bd_pins util_ds_buf_1/BUFG_O]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins AXIS_LMAC_0/fmac_speed] [get_bd_pins xlconstant_0/dout]
