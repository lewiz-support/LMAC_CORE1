...
//Command     : generate_target ps_emio_eth_1g_wrapper.bd
//Design      : ps_emio_eth_1g_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module ps_emio_eth_1g_wrapper
   (clk_125_clk_n,
    clk_125_clk_p,
    dir_125_clk_led,
    gtrefclk_in_clk_n,
  ...
  wire s_axis_tready_led;
  wire sfp_rxn;
  wire sfp_rxp;
  wire [0:0]sfp_tx_dis;
  wire sfp_txn;
  wire sfp_txp;
  wire [0:0]xcvr_rst_done_led;

  ps_emio_eth_1g ps_emio_eth_1g_i
       (.clk_125_clk_n(clk_125_clk_n),
        ...
        .s_axis_tready_led(s_axis_tready_led),
        .sfp_rxn(sfp_rxn),
        .sfp_rxp(sfp_rxp),
