...
HD_PWD='/home/lewiz/sambashare/KIRATEY/RELEASE/runs_lmac_eth_1g_xczu9eg/ps_emio_eth_1g.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_emio_eth_1g_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ps_emio_eth_1g_wrapper.tcl -notrace
