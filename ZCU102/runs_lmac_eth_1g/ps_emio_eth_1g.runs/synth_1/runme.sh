...
HD_PWD='/home/lewiz/sambashare/KIRATEY/RELEASE/runs_lmac_eth_1g_xczu9eg/ps_emio_eth_1g.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_emio_eth_1g_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps_emio_eth_1g_wrapper.tcl
