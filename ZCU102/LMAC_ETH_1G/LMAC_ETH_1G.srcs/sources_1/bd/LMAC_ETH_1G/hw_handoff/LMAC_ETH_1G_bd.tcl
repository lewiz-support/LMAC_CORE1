...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net c_counter_binary_1_Q [get_bd_pins c_counter_binary_1/Q] [get_bd_pins ila_0/clk] [get_bd_pins xlslice_1/Din]
