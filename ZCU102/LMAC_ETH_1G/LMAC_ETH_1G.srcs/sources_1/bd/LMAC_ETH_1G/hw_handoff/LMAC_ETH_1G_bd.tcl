...
################################################################
# This is a generated script based on design: LMAC_ETH_1G
#
...
if { $list_projs eq "" } {
   create_project project_1 myproj -part xczu15eg-ffvb1156-2-e
}


# CHANGE DESIGN NAME HERE
variable design_name
set design_name LMAC_ETH_1G
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set dir_125_clk_led [ create_bd_port -dir O -from 0 -to 0 dir_125_clk_led ]
  ...
  set pl_reset_led [ create_bd_port -dir O -from 0 -to 0 -type rst pl_reset_led ]
  set sfp_tx_dis [ create_bd_port -dir O -from 0 -to 0 sfp_tx_dis ]
  set xcvr_rst_done_led [ create_bd_port -dir O xcvr_rst_done_led ]

  # Create instance: AXIS_LMAC_IP_0, and set properties
  set AXIS_LMAC_IP_0 [ create_bd_cell -type ip -vlnv lewiz:user:AXIS_LMAC_IP:1.0 AXIS_LMAC_IP_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#TTC 0#TTC 0#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#I2C 0#I2C 0#I2C 1#I2C 1#UART 0#UART 0#UART 1#UART 1#GPIO0 MIO#GPIO0 MIO#CAN 1#CAN 1#GPIO1 MIO#DPAUX#DPAUX#DPAUX#DPAUX#PCIE#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
   CONFIG.PSU_MIO_TREE_SIGNALS {gpio0[0]#gpio0[1]#gpio0[2]#gpio0[3]#gpio0[4]#gpio0[5]#clk_in#wave_out#gpio0[8]#gpio0[9]#gpio0[10]#gpio0[11]#gpio0[12]#gpio0[13]#scl_out#sda_out#scl_out#sda_out#rxd#txd#txd#rxd#gpio0[22]#gpio0[23]#phy_tx#phy_rx#gpio1[26]#dp_aux_data_out#dp_hot_plug_detect#dp_aux_data_oe#dp_aux_data_in#reset_n#gpio1[32]#gpio1[33]#gpio1[34]#gpio1[35]#gpio1[36]#gpio1[37]#gpio1[38]#sdio1_data_out[4]#sdio1_data_out[5]#sdio1_data_out[6]#sdio1_data_out[7]#sdio1_bus_pow#sdio1_wp#sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem3_mdc#gem3_mdio_out} \
   ...
   CONFIG.PSU__CRF_APB__PCIE_REF_CTRL__ACT_FREQMHZ {249.997500} \
  ...
  connect_bd_intf_net -intf_net AXIS_LMAC_IP_0_gmii [get_bd_intf_pins AXIS_LMAC_IP_0/gmii] [get_bd_intf_pins gig_ethernet_pcs_pma_0/gmii_pcs_pma]
  connect_bd_intf_net -intf_net AXIS_LMAC_IP_0_m_axis [get_bd_intf_pins AXIS_LMAC_IP_0/m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins AXIS_LMAC_IP_0/s_axis] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_net -net AXIS_LMAC_IP_0_axis2fib_ar_state [get_bd_pins AXIS_LMAC_IP_0/axis2fib_ar_state] [get_bd_pins ila_3/probe7]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_axis2fib_ar_state]
  connect_bd_net -net AXIS_LMAC_IP_0_axis2fib_txctrl_st [get_bd_pins AXIS_LMAC_IP_0/axis2fib_txctrl_st] [get_bd_pins ila_2/probe19]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_axis2fib_txctrl_st]
  connect_bd_net -net AXIS_LMAC_IP_0_bcnt_more_than_1500 [get_bd_pins AXIS_LMAC_IP_0/bcnt_more_than_1500] [get_bd_pins ila_2/probe10]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_bcnt_more_than_1500]
  connect_bd_net -net AXIS_LMAC_IP_0_cs_fifo_empty_reg [get_bd_pins AXIS_LMAC_IP_0/cs_fifo_empty_reg] [get_bd_pins ila_1/probe7]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_cs_fifo_empty_reg]
  connect_bd_net -net AXIS_LMAC_IP_0_dataout_rcf [get_bd_pins AXIS_LMAC_IP_0/dataout_rcf] [get_bd_pins ila_3/probe3]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_dataout_rcf]
  connect_bd_net -net AXIS_LMAC_IP_0_dataout_rf [get_bd_pins AXIS_LMAC_IP_0/dataout_rf] [get_bd_pins ila_3/probe2]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_dataout_rf]
  connect_bd_net -net AXIS_LMAC_IP_0_dataout_wcf [get_bd_pins AXIS_LMAC_IP_0/dataout_wcf] [get_bd_pins ila_1/probe3]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_dataout_wcf]
  connect_bd_net -net AXIS_LMAC_IP_0_dataout_wf [get_bd_pins AXIS_LMAC_IP_0/dataout_wf] [get_bd_pins ila_1/probe2]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_dataout_wf]
  connect_bd_net -net AXIS_LMAC_IP_0_fib2fmac_txctrl_st [get_bd_pins AXIS_LMAC_IP_0/fib2fmac_txctrl_st] [get_bd_pins ila_1/probe12]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_fib2fmac_txctrl_st]
  connect_bd_net -net AXIS_LMAC_IP_0_fmac2fib_ar_state [get_bd_pins AXIS_LMAC_IP_0/fmac2fib_ar_state] [get_bd_pins ila_1/probe8]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_fmac2fib_ar_state]
  connect_bd_net -net AXIS_LMAC_IP_0_gmii_tx_en [get_bd_pins AXIS_LMAC_IP_0/gmii_tx_en] [get_bd_pins gig_ethernet_pcs_pma_0/gmii_tx_en] [get_bd_pins ila_0/probe1]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_gmii_tx_en]
  connect_bd_net -net AXIS_LMAC_IP_0_gmii_tx_er [get_bd_pins AXIS_LMAC_IP_0/gmii_tx_er] [get_bd_pins gig_ethernet_pcs_pma_0/gmii_tx_er]
  connect_bd_net -net AXIS_LMAC_IP_0_gmii_txd [get_bd_pins AXIS_LMAC_IP_0/gmii_txd] [get_bd_pins gig_ethernet_pcs_pma_0/gmii_txd] [get_bd_pins ila_0/probe0]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_gmii_txd]
  connect_bd_net -net AXIS_LMAC_IP_0_m_axis_tdata [get_bd_pins AXIS_LMAC_IP_0/m_axis_tdata] [get_bd_pins axi_dma_0/s_axis_s2mm_tdata] [get_bd_pins ila_2/probe5]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_m_axis_tdata]
  connect_bd_net -net AXIS_LMAC_IP_0_m_axis_tkeep [get_bd_pins AXIS_LMAC_IP_0/m_axis_tkeep] [get_bd_pins axi_dma_0/s_axis_s2mm_tkeep] [get_bd_pins ila_2/probe6]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_m_axis_tkeep]
  connect_bd_net -net AXIS_LMAC_IP_0_m_axis_tlast [get_bd_pins AXIS_LMAC_IP_0/m_axis_tlast] [get_bd_pins axi_dma_0/s_axis_s2mm_tlast] [get_bd_pins ila_2/probe7]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_m_axis_tlast]
  connect_bd_net -net AXIS_LMAC_IP_0_m_axis_tvalid [get_bd_pins AXIS_LMAC_IP_0/m_axis_tvalid] [get_bd_pins axi_dma_0/s_axis_s2mm_tvalid] [get_bd_pins ila_2/probe8]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_m_axis_tvalid]
  connect_bd_net -net AXIS_LMAC_IP_0_rdempty_rcf [get_bd_pins AXIS_LMAC_IP_0/rdempty_rcf] [get_bd_pins ila_3/probe1]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_rdempty_rcf]
  connect_bd_net -net AXIS_LMAC_IP_0_rdempty_rf [get_bd_pins AXIS_LMAC_IP_0/rdempty_rf] [get_bd_pins ila_3/probe0]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_rdempty_rf]
  connect_bd_net -net AXIS_LMAC_IP_0_rdempty_wcf [get_bd_pins AXIS_LMAC_IP_0/rdempty_wcf] [get_bd_pins ila_1/probe1]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_rdempty_wcf]
  connect_bd_net -net AXIS_LMAC_IP_0_rdempty_wf [get_bd_pins AXIS_LMAC_IP_0/rdempty_wf] [get_bd_pins ila_1/probe0]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_rdempty_wf]
  connect_bd_net -net AXIS_LMAC_IP_0_rden_rcf [get_bd_pins AXIS_LMAC_IP_0/rden_rcf] [get_bd_pins ila_3/probe5]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_rden_rcf]
  connect_bd_net -net AXIS_LMAC_IP_0_rden_rf [get_bd_pins AXIS_LMAC_IP_0/rden_rf] [get_bd_pins ila_3/probe4]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_rden_rf]
  connect_bd_net -net AXIS_LMAC_IP_0_rden_wcf [get_bd_pins AXIS_LMAC_IP_0/rden_wcf] [get_bd_pins ila_1/probe5]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_rden_wcf]
  connect_bd_net -net AXIS_LMAC_IP_0_rden_wf [get_bd_pins AXIS_LMAC_IP_0/rden_wf] [get_bd_pins ila_1/probe4]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_rden_wf]
  connect_bd_net -net AXIS_LMAC_IP_0_rx_mac_empty_reg [get_bd_pins AXIS_LMAC_IP_0/rx_mac_empty_reg] [get_bd_pins ila_1/probe6]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_rx_mac_empty_reg]
  connect_bd_net -net AXIS_LMAC_IP_0_s_axis_tready [get_bd_pins AXIS_LMAC_IP_0/s_axis_tready] [get_bd_pins axi_dma_0/m_axis_mm2s_tready] [get_bd_pins ila_2/probe3]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_s_axis_tready]
  connect_bd_net -net AXIS_LMAC_IP_0_tx_mac_data_reg [get_bd_pins AXIS_LMAC_IP_0/tx_mac_data_reg] [get_bd_pins ila_1/probe10]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_tx_mac_data_reg]
  connect_bd_net -net AXIS_LMAC_IP_0_tx_mac_usedw_reg [get_bd_pins AXIS_LMAC_IP_0/tx_mac_usedw_reg] [get_bd_pins ila_1/probe11]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_tx_mac_usedw_reg]
  connect_bd_net -net AXIS_LMAC_IP_0_tx_mac_wr_reg [get_bd_pins AXIS_LMAC_IP_0/tx_mac_wr_reg] [get_bd_pins ila_1/probe9]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_tx_mac_wr_reg]
  connect_bd_net -net AXIS_LMAC_IP_0_txdata_wrempty [get_bd_pins AXIS_LMAC_IP_0/txdata_wrempty] [get_bd_pins ila_2/probe16]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_txdata_wrempty]
  connect_bd_net -net AXIS_LMAC_IP_0_txdata_wrfull [get_bd_pins AXIS_LMAC_IP_0/txdata_wrfull] [get_bd_pins ila_3/probe6]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_txdata_wrfull]
  connect_bd_net -net AXIS_LMAC_IP_0_txdata_wrreq [get_bd_pins AXIS_LMAC_IP_0/txdata_wrreq] [get_bd_pins ila_2/probe17]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_txdata_wrreq]
  connect_bd_net -net AXIS_LMAC_IP_0_txdata_wrusedw [get_bd_pins AXIS_LMAC_IP_0/txdata_wrusedw] [get_bd_pins ila_2/probe18]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_txdata_wrusedw]
  connect_bd_net -net AXIS_LMAC_IP_0_txwbcnt_wrempty [get_bd_pins AXIS_LMAC_IP_0/txwbcnt_wrempty] [get_bd_pins ila_2/probe13]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_txwbcnt_wrempty]
  connect_bd_net -net AXIS_LMAC_IP_0_txwbcnt_wrreq [get_bd_pins AXIS_LMAC_IP_0/txwbcnt_wrreq] [get_bd_pins ila_2/probe12]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_txwbcnt_wrreq]
  connect_bd_net -net AXIS_LMAC_IP_0_txwbcnt_wrusedw [get_bd_pins AXIS_LMAC_IP_0/txwbcnt_wrusedw] [get_bd_pins ila_2/probe14]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_txwbcnt_wrusedw]
  connect_bd_net -net AXIS_LMAC_IP_0_wr2_txdata_fifo [get_bd_pins AXIS_LMAC_IP_0/wr2_txdata_fifo] [get_bd_pins ila_2/probe15]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_wr2_txdata_fifo]
  connect_bd_net -net AXIS_LMAC_IP_0_wr2_txwbcnt_fifo [get_bd_pins AXIS_LMAC_IP_0/wr2_txwbcnt_fifo] [get_bd_pins ila_2/probe11]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_wr2_txwbcnt_fifo]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tdata [get_bd_pins AXIS_LMAC_IP_0/s_axis_tdata] [get_bd_pins axi_dma_0/m_axis_mm2s_tdata] [get_bd_pins ila_2/probe0]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets axi_dma_0_m_axis_mm2s_tdata]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tkeep [get_bd_pins AXIS_LMAC_IP_0/s_axis_tkeep] [get_bd_pins axi_dma_0/m_axis_mm2s_tkeep] [get_bd_pins ila_2/probe1]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets axi_dma_0_m_axis_mm2s_tkeep]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tlast [get_bd_pins AXIS_LMAC_IP_0/s_axis_tlast] [get_bd_pins axi_dma_0/m_axis_mm2s_tlast] [get_bd_pins ila_2/probe2]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets axi_dma_0_m_axis_mm2s_tlast]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tvalid [get_bd_pins AXIS_LMAC_IP_0/s_axis_tvalid] [get_bd_pins axi_dma_0/m_axis_mm2s_tvalid] [get_bd_pins ila_2/probe4]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets axi_dma_0_m_axis_mm2s_tvalid]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_dma_0_s_axis_s2mm_tready [get_bd_pins AXIS_LMAC_IP_0/m_axis_tready] [get_bd_pins axi_dma_0/s_axis_s2mm_tready] [get_bd_pins ila_2/probe9]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets axi_dma_0_s_axis_s2mm_tready]
  ...
  connect_bd_net -net gig_ethernet_pcs_pma_0_gmii_rx_dv [get_bd_pins AXIS_LMAC_IP_0/gmii_rx_dv] [get_bd_pins gig_ethernet_pcs_pma_0/gmii_rx_dv] [get_bd_pins ila_0/probe3]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets gig_ethernet_pcs_pma_0_gmii_rx_dv]
  connect_bd_net -net gig_ethernet_pcs_pma_0_gmii_rx_er [get_bd_pins AXIS_LMAC_IP_0/gmii_rx_er] [get_bd_pins gig_ethernet_pcs_pma_0/gmii_rx_er] [get_bd_pins ila_0/probe4]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets gig_ethernet_pcs_pma_0_gmii_rx_er]
  connect_bd_net -net gig_ethernet_pcs_pma_0_gmii_rxd [get_bd_pins AXIS_LMAC_IP_0/gmii_rxd] [get_bd_pins gig_ethernet_pcs_pma_0/gmii_rxd] [get_bd_pins ila_0/probe2]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets gig_ethernet_pcs_pma_0_gmii_rxd]
  connect_bd_net -net gig_ethernet_pcs_pma_0_resetdone [get_bd_ports xcvr_rst_done_led] [get_bd_pins AXIS_LMAC_IP_0/rst_] [get_bd_pins gig_ethernet_pcs_pma_0/resetdone]
  connect_bd_net -net gig_ethernet_pcs_pma_0_status_vector [get_bd_pins gig_ethernet_pcs_pma_0/status_vector] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_3/Din]
  connect_bd_net -net gig_ethernet_pcs_pma_0_userclk2_out [get_bd_pins AXIS_LMAC_IP_0/lclk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins gig_ethernet_pcs_pma_0/userclk2_out] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk]
  connect_bd_net -net rst_ps8_0_49M_interconnect_aresetn [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins rst_ps8_0_49M/interconnect_aresetn]
  connect_bd_net -net rst_ps8_0_49M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_49M/peripheral_aresetn]
  connect_bd_net -net rst_ps8_0_49M_peripheral_reset [get_bd_ports pl_reset_led] [get_bd_pins gig_ethernet_pcs_pma_0/reset] [get_bd_pins rst_ps8_0_49M/peripheral_reset]
  connect_bd_net -net util_ds_buf_0_IBUF_OUT [get_bd_pins util_ds_buf_0/IBUF_OUT] [get_bd_pins util_ds_buf_1/BUFG_I]
  connect_bd_net -net util_ds_buf_1_BUFG_O [get_bd_pins c_counter_binary_1/CLK] [get_bd_pins util_ds_buf_1/BUFG_O]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins AXIS_LMAC_IP_0/fmac_speed] [get_bd_pins xlconstant_0/dout]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins gig_ethernet_pcs_pma_0/an_adv_config_vector] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins gig_ethernet_pcs_pma_0/an_restart_config] [get_bd_pins xlconstant_3/dout]
  connect_bd_net -net xlconstant_4_dout [get_bd_pins gig_ethernet_pcs_pma_0/signal_detect] [get_bd_pins xlconstant_4/dout]
  connect_bd_net -net xlconstant_5_dout [get_bd_ports sfp_tx_dis] [get_bd_pins xlconstant_5/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports pcs_clk_led] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_ports dir_125_clk_led] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_ports link_status_led] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_ports link_sync_led] [get_bd_pins xlslice_3/Dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins AXIS_LMAC_IP_0/dclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins ila_2/clk] [get_bd_pins ila_3/clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_49M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins gig_ethernet_pcs_pma_0/independent_clock_bufg] [get_bd_pins zynq_ultra_ps_e_0/pl_clk1]
