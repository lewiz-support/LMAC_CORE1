...
HD_PWD='/home/lewiz/sambashare/KIRATEY/RELEASE/LMAC_ETH_1G/AXIS_LMAC_IP/AXIS_LMAC_IP.runs/rxfifo_ip_4Kx64_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rxfifo_ip_4Kx64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rxfifo_ip_4Kx64.tcl
