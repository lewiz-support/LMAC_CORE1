...
HD_PWD='/home/lewiz/sambashare/KIRATEY/RELEASE/LMAC_ETH_1G/AXIS_LMAC_IP/AXIS_LMAC_IP.runs/gigerx_fifo_ip_256x64_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gigerx_fifo_ip_256x64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gigerx_fifo_ip_256x64.tcl
