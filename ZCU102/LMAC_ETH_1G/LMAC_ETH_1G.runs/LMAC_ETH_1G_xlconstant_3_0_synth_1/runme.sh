...
HD_PWD='/home/lewiz/sambashare/KIRATEY/RELEASE/LMAC_ETH_1G_xczu9eg/LMAC_ETH_1G.runs/LMAC_ETH_1G_xlconstant_3_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LMAC_ETH_1G_xlconstant_3_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LMAC_ETH_1G_xlconstant_3_0.tcl
