...
HD_PWD='/home/lewiz2/lewiz2-sambashare/KIRATEY/LMAC_ETH_1G_NEW_BRIDGE/LMAC_ETH_1G.runs/LMAC_ETH_1G_util_ds_buf_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LMAC_ETH_1G_util_ds_buf_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LMAC_ETH_1G_util_ds_buf_0_0.tcl
