...
set psu_pll_init_data {
    ...
    mask_write 0XFD1A003C 0xFE7FEDEF 0x7E546C62
		# : UPDATE FB_DIV
    ...
    mask_write 0XFD1A0038 0x00717F00 0x00013600
		# : BY PASS PLL
		# Register : VPLL_CTRL @ 0XFD1A0038</p>
...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E00A4 0x01003F07 0x01000502
    ...
    mask_write 0XFD1A0070 0x013F3F07 0x01010300
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0xFFFFFFFF 0xD2240040
