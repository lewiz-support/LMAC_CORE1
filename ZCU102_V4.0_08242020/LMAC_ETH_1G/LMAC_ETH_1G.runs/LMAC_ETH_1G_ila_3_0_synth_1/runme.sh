...
HD_PWD='/home/lewiz/sambashare/KIRATEY/LMAC1_INTEGRATED/LMAC_ETH_1G/LMAC_ETH_1G.runs/LMAC_ETH_1G_ila_3_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LMAC_ETH_1G_ila_3_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LMAC_ETH_1G_ila_3_0.tcl
