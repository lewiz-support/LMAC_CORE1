...
begin
	if(!rst_)
	wdata <= 64'hd555555555555555;
	
	else begin	   
// data output
	wdata <= mode_1G? (p_send? p_data : (wsel? 64'hd555555555555555 : txfifo_dout)) :
	         (p_send? p_data : (wsel? ((st_idle & pulse_0)? 64'hd555555555555555 : wdata) : ((st_mac_dat & pulse_0)? txfifo_dout : wdata)));
	end
end
