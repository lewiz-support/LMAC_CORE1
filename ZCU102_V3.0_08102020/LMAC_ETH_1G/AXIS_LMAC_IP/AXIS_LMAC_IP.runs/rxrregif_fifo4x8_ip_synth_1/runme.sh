...
HD_PWD='/home/lewiz/sambashare/KIRATEY/RELEASE/LMAC_ETH_1G/AXIS_LMAC_IP/AXIS_LMAC_IP.runs/rxrregif_fifo4x8_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rxrregif_fifo4x8_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rxrregif_fifo4x8_ip.tcl
