...
HD_PWD='/home/lewiz/sambashare/KIRATEY/RELEASE/LMAC_ETH_1G/AXIS_LMAC_IP/AXIS_LMAC_IP.runs/txwbcnt_fifo4x32_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log txwbcnt_fifo4x32_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source txwbcnt_fifo4x32_ip.tcl
