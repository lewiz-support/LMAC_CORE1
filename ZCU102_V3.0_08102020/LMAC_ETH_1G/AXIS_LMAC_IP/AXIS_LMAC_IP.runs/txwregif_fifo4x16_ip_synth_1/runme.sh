...
HD_PWD='/home/lewiz/sambashare/KIRATEY/RELEASE/LMAC_ETH_1G/AXIS_LMAC_IP/AXIS_LMAC_IP.runs/txwregif_fifo4x16_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log txwregif_fifo4x16_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source txwregif_fifo4x16_ip.tcl
