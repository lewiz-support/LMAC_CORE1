...
HD_PWD='/home/lewiz/sambashare/KIRATEY/RELEASE/LMAC_ETH_1G/AXIS_LMAC_IP/AXIS_LMAC_IP.runs/ipcs_fifo_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ipcs_fifo_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ipcs_fifo_ip.tcl
