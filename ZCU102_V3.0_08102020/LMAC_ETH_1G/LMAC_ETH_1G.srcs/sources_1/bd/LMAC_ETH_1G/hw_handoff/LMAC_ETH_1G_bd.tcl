...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net AXIS_LMAC_IP_0_bcnt_more_than_1500 [get_bd_pins AXIS_LMAC_IP_0/bcnt_more_than_1500] [get_bd_pins ila_1/probe15]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_bcnt_more_than_1500]
  connect_bd_net -net AXIS_LMAC_IP_0_cs_fifo_empty [get_bd_pins AXIS_LMAC_IP_0/cs_fifo_empty] [get_bd_pins ila_1/probe14]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_cs_fifo_empty]
  connect_bd_net -net AXIS_LMAC_IP_0_dataout_rcf [get_bd_pins AXIS_LMAC_IP_0/dataout_rcf] [get_bd_pins ila_1/probe9]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_dataout_rcf]
  connect_bd_net -net AXIS_LMAC_IP_0_dataout_rf [get_bd_pins AXIS_LMAC_IP_0/dataout_rf] [get_bd_pins ila_1/probe8]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net AXIS_LMAC_IP_0_rdempty_rcf [get_bd_pins AXIS_LMAC_IP_0/rdempty_rcf] [get_bd_pins ila_1/probe7]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_rdempty_rcf]
  connect_bd_net -net AXIS_LMAC_IP_0_rdempty_rf [get_bd_pins AXIS_LMAC_IP_0/rdempty_rf] [get_bd_pins ila_1/probe6]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net AXIS_LMAC_IP_0_rden_rcf [get_bd_pins AXIS_LMAC_IP_0/rden_rcf] [get_bd_pins ila_1/probe11]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_rden_rcf]
  connect_bd_net -net AXIS_LMAC_IP_0_rden_rf [get_bd_pins AXIS_LMAC_IP_0/rden_rf] [get_bd_pins ila_1/probe10]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net AXIS_LMAC_IP_0_rx_mac_empty [get_bd_pins AXIS_LMAC_IP_0/rx_mac_empty] [get_bd_pins ila_1/probe13]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets AXIS_LMAC_IP_0_rx_mac_empty]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net AXIS_LMAC_IP_0_txdata_wrfull [get_bd_pins AXIS_LMAC_IP_0/txdata_wrfull] [get_bd_pins ila_1/probe12]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net gig_ethernet_pcs_pma_0_userclk2_out [get_bd_pins AXIS_LMAC_IP_0/lclk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins gig_ethernet_pcs_pma_0/userclk2_out]
  ...
  connect_bd_net -net util_ds_buf_1_BUFG_O [get_bd_pins c_counter_binary_1/CLK] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins util_ds_buf_1/BUFG_O]
