...
HD_PWD='/home/lewiz2/lewiz2-sambashare/KIRATEY/LMAC_ETH_1G_NEW_BRIDGE/LMAC_ETH_1G.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LMAC_ETH_1G_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LMAC_ETH_1G_wrapper.tcl -notrace
