...
#
# Generated by export_simulation on Mon Apr 08 15:02:47 PDT 2019
#
################################################################################
...
'-reset_run' switch to the './LMAC_ETH_1G.sh' script.

./LMAC_ETH_1G.sh -reset_run
...
./LMAC_ETH_1G.sh -noclean_files

For more information on the script, please type './LMAC_ETH_1G.sh -help'.
