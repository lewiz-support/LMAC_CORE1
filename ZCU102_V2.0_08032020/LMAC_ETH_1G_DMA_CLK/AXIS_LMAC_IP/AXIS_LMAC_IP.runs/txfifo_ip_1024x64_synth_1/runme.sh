...
HD_PWD='/home/lewiz/sambashare/KIRATEY/RELEASE/LMAC_ETH_1G/AXIS_LMAC_IP/AXIS_LMAC_IP.runs/txfifo_ip_1024x64_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log txfifo_ip_1024x64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source txfifo_ip_1024x64.tcl
