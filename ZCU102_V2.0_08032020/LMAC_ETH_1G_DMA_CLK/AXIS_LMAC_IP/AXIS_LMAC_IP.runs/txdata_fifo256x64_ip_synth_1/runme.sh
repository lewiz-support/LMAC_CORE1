...
HD_PWD='/home/lewiz/sambashare/KIRATEY/RELEASE/LMAC_ETH_1G/AXIS_LMAC_IP/AXIS_LMAC_IP.runs/txdata_fifo256x64_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log txdata_fifo256x64_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source txdata_fifo256x64_ip.tcl
