...
HD_PWD='/home/lewiz/sambashare/KIRATEY/RELEASE/LMAC_ETH_1G/AXIS_LMAC_IP/AXIS_LMAC_IP.runs/br_sfifo_ip_4x32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log br_sfifo_ip_4x32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source br_sfifo_ip_4x32.tcl
